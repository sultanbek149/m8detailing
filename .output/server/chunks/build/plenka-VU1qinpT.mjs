...
const _imports_2 = publicAssetsURL("/img/carbody.jpg");
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const info = useInfo();
    useRoute();
    const feature = getFeatures("plenka");
    useSeoMeta({
      ...
      _push(ssrRenderComponent(_component_LandingContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16"${_scopeId}><div${_scopeId}><h2 class="font-medium text-2xl text-gray-400"${_scopeId}>\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</h2><div class="mt-5 text-slate-500"${_scopeId}><div class="flex flex-col gap-3"${_scopeId}>${(_a = unref(feature).content) != null ? _a : ""}</div></div><p class="text-slate-600 mt-2 mb-5 leading-relaxed text-[16px]"${_scopeId}>${ssrInterpolate(unref(feature).price)}</p><a${ssrRenderAttr("href", unref(info).wsLink)} class="bg-silver rounded-lg py-2 px-6 mt-4 w-full flex justify-center text-center"${_scopeId}> \u041F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u0443\u044E \u043A\u043E\u043D\u0441\u0443\u043B\u044C\u0442\u0430\u0446\u0438\u044E </a></div><div${_scopeId}><div class="mt-1 w-58 h-68"${_scopeId}><div class="w-full aspect-square"${_scopeId}><img${ssrRenderAttr("src", unref(feature).img.src)}${ssrRenderAttr("width", unref(feature).img.width)}${ssrRenderAttr("height", unref(feature).img.height)} format="avif"${ssrRenderAttr("alt", unref(feature).title)} class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl"${_scopeId}></div></div></div></div><div class="mx-auto mt-20"${_scopeId}><p class="text-center text-4xl font-bold mb-5 text-2xl text-white"${_scopeId}>\u041F\u0430\u043A\u0435\u0442\u044B \u043E\u043A\u043B\u0435\u0439\u043A\u0438</p><div class="flex items-center justify-center flex-col sm:flex-row gap-4"${_scopeId}><div class=""${_scopeId}><img${ssrRenderAttr("src", _imports_0)} alt="plenka" class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl"${_scopeId}></div><div${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="plenka" class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl"${_scopeId}></div><div${_scopeId}><img${ssrRenderAttr("src", _imports_2)} alt="plenka" class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl"${_scopeId}></div></div></div><div class="mx-auto mt-20"${_scopeId}><p class="text-center text-4xl font-bold mb-5 text-2xl text-white"${_scopeId}>\u0422\u0430\u043A\u0436\u0435 \u043F\u0440\u0435\u0434\u043E\u0441\u0442\u0430\u0432\u043B\u044F\u0435\u043C \u043A\u043E\u043C\u043F\u043B\u0435\u043A\u0441\u043D\u043E\u0435 \u043E\u0431\u0441\u043B\u0443\u0436\u0438\u0432\u0430\u043D\u0438\u0435 \u0432\u0441\u0435\u0433\u043E \u0430\u0432\u0442\u043E\u043C\u043E\u0431\u0438\u043B\u044F (\u0422\u0430\u043A\u0436\u0435 \u043D\u0430\u0448\u0438 \u0443\u0441\u043B\u0443\u0433\u0438)</p>`);
            _push2(ssrRenderComponent(_component_LandingFeaturesCard, { "exclude-slug": "plenka" }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16" }, [
                createVNode("div", null, [
                  ...
                  }, " \u041F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u0443\u044E \u043A\u043E\u043D\u0441\u0443\u043B\u044C\u0442\u0430\u0446\u0438\u044E ", 8, ["href"])
                ]),
                createVNode("div", null, [
              ...
              createVNode("div", { class: "mx-auto mt-20" }, [
                createVNode("p", { class: "text-center text-4xl font-bold mb-5 text-2xl text-white" }, "\u041F\u0430\u043A\u0435\u0442\u044B \u043E\u043A\u043B\u0435\u0439\u043A\u0438"),
              ...
              createVNode("div", { class: "mx-auto mt-20" }, [
                ...
                createVNode(_component_LandingFeaturesCard, { "exclude-slug": "plenka" })
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/plenka.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=plenka-VU1qinpT.mjs.map
