...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "detailing-himchistka-salona",
  __ssrInlineRender: true,
  setup(__props) {
    const info = useInfo();
    useRoute();
    const feature = getFeatures("detailing-himchistka-salona");
    useSeoMeta({
            ...
            return [
              ...
              createVNode("div", { class: "grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16" }, [
                createVNode("div", null, [
                  ...
                  }, " \u0417\u0430\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F \u043D\u0430 \u0445\u0438\u043C\u0447\u0438\u0441\u0442\u043A\u0443 ", 8, ["href"])
                ]),
                createVNode("div", null, [
              ...
              createVNode("div", { class: "mx-auto mt-20" }, [
                ...
                createVNode(_component_LandingFeaturesCard, { "exclude-slug": "detailing-himchistka-salona" })
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/detailing-himchistka-salona.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=detailing-himchistka-salona-D5N00cK-.mjs.map
