...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1 maximum-scale=1"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[{"type":"text/javascript","src":"/scripts/yametrika.js","async":true,"defer":true}],"noscript":[]};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.ak; }).then((r) => r.default || r);
