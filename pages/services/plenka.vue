<template>
  <LandingContainer>
    ...
    <div class="mx-auto mt-20">
      <p class="text-center text-4xl font-bold mb-5 text-2xl text-white">Пакеты оклейки</p>


      <div class="flex items-center justify-center flex-col sm:flex-row gap-4">
        <div class="">
          <img src="/img/headlight.jpg" alt="plenka"
            class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl">
        </div>
        <div>
          <img src="/img/bumper.jpg" alt="plenka"
            class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl">
        </div>
        <div>
          <img src="/img/carbody.jpg" alt="plenka"
            class="w-full h-full object-cover rounded transition group-hover:-translate-y-1 group-hover:shadow-xl">
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto mt-20">
      ...
      <LandingFeaturesCard exclude-slug="plenka"/>
    </div>
